...
Standalone external-consumer demo repo for `quasuki-sdk@0.2.3`.
...
- install `quasuki-sdk@0.2.3` from npm
...
- release: `https://github.com/quasuki/quasuki-sdk/releases/tag/v0.2.3`
